...
<div class="site-section">
    ...
    <div class="row">
        <div class="col-md-12">
        <h2 class="h3 mb-3 text-black">Kritik dan Saran</h2>
        </div>
        <div class="col-md-7">
        ...
        <div class="col-md-5 ml-auto">
            ...
            <div class="p-4 border mb-3">
                <span class="d-block text-primary h6 text-uppercase">{{$data->subject}}</span>
                <p class="mb-0">{{$data->notes}}</p>
                <span class="float-right mb-3">{{$data->name}}</span>
            </div>
            @endforeach
        </div>
    </div>
