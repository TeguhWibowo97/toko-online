...
<html lang="en">
  <head>
    <title>Rima Store &mdash; Toko Olahraga Online </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="{{url('/')}}" class="js-logo-clone">RIMA STORE</a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mb-5 mb-lg-0">
            <div class="row">
              ...
              <div class="embed-rsponsive embed-responsive-3by4">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.2240465017576!2d110.40690801424614!3d-6.982866294955518!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708b4ec52229d7%3A0xc791d6abc9236c7!2sUniversitas%20Dian%20Nuswantoro!5e0!3m2!1sid!2sid!4v1633838412311!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-6 p-5">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jl. Simanjuntak No. 655, Pati</li>
                <li class="phone"><a href="tel://23923929210">+62 888 999 111</a></li>
                <li class="email">rimastore@gmail.com</li>
              </ul>
            </div>            
          </div>
        </div>
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved | Rima Store <i class="icon-heart" aria-hidden="true"></i>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
